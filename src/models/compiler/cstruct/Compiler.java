...
public class Compiler {
    ...
    public void setAlreadyProcessed(List<File> alreadyProcessed) {
        this.alreadyProcessed = alreadyProcessed;
    }

    public List<Adt> getAdts() {
        return adts;
    }
    ...
    public Map<String, String> getDefinesProcedency() {
        return definesProcedency;
    }
